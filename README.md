...
- Replace `<your_account>` with your Github username in the
 [DEMO LINK](https://sasha39612.github.io/react_movies-list-fetch-movies/)
- Follow the [React task guideline](https://github.com/mate-academy/react_task-guideline#react-tasks-guideline)

## Task
Implement `previewMovie` component to load movies from [OMDb API](http://www.omdbapi.com/) (You need to register and get an API key).
...
1. If film is not found show an nameError message below the input. Hide the nameError after changing a title.
