...
1. Show a spinner on the submit button while waiting for the response;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://kseniia-chepur.github.io/react_movies-list-fetch-movies/) and add it to the PR description.
