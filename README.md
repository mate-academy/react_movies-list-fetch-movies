...
1. When a user enters a title and submits the form, send a request to `https://www.omdbapi.com/?apikey=3bc85056&t=[title]`;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://pozdnia.github.io/react_movies-list-fetch-movies/) and add it to the PR description.
