...
- Replace `<your_account>` with your Github username in the
 [DEMO LINK](https://sashapylypyuk.github.io/react_movies-list-fetch-movies/)
...
1. When user enters a movie title and clicks a search button, send a request to `http://www.omdbapi.com/?apikey=[yourkey]&t=[title]`. `http://www.omdbapi.com/?i=tt3896198&apikey=fbcb17c`
