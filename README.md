...
1. If a movie is found show the preview as a `MovieCard` and the add button;
    - the API return `MovieData` or `ResposnseError` (see the `types`)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://mary-kucher.github.io/react_movies-list-fetch-movies/) and add it to the PR description.
