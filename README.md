...
- Replace `<your_account>` with your Github username in the
 [DEMO LINK](https://Basil-Panasiuk.github.io/react_movies-list-fetch-movies/)
...
1. When user enters a movie title and clicks a search button, send a request to `https://www.omdbapi.com/?apikey=[4ab6445f]&t=[title]`.
