...
Implement the `FindMovie` component to load movies from [OMDb API](http://ww-w.omdbapi.com/) (You need to register and get an API key).
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://denenergi.github.io/react_movies-list-fetch-movies/) and add it to the PR description.
