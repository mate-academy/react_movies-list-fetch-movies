...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://MAIK-01.github.io/react_movies-list-fetch-movies/) and add it to the PR description.
