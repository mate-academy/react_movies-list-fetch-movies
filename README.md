...
- Replace `<your_account>` with your Github username in the
 [DEMO LINK](https://samson-sim.github.io/react_movies-list-fetch-movies/)
...
1. When user enters a movie title and clicks a search button, send a request to `https://www.omdbapi.com/?apikey=ebc435ec&t=[title]`.
