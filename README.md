...
- Replace `<your_account>` with your Github username in the
 [DEMO LINK](https://tumann21.github.io/react_movies-list-fetch-movies/)
...
1. When user enters a movie title and clicks a search button, send a request to `https://www.omdbapi.com/?apikey=b9cb9612&t=[title]`.
