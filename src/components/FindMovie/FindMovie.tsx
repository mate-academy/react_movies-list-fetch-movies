    ...
    getMovie(title)
      .then((response) => {
        ...
        if ('Title' in response) {
          ...
          const movieDataNormalized = Object.fromEntries(Object.entries(response).filter(([key]) => allowedKeys.includes(key)));

          if (movieDataNormalized.Poster && movieDataNormalized.Poster.length < 5) {
            movieDataNormalized.Poster = 'https://via.placeholder.com/360x270.png?text=no%20preview';
          }
